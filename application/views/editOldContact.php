<?php
$contactId = $contactInfo->id_contact;
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>contact/editContact" method="post" id="editContact" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $contactId; ?>" name="contactId" id="contactId" />    
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mobile" placeholder="Notes" name="note" value="<?php echo $note; ?>" maxlength="200">
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
