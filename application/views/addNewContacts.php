            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addContact" action="<?php echo base_url() ?>contacts/doAddNew" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $uid; ?>" name="userId" id="userId" /> 
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required " id="note" value="<?php echo set_value('note'); ?>" name="note" maxlength="128">
                                    </div>
                                </div>   
                            </div>
                        </div><!-- /.box-body -->
